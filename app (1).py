...
# --- 8. AI Forecasting (ສະບັບແກ້ໄຂ Error ໃຫ້ອ້າຍໂດຍສະເພາະ) ---
    ...
    if len(daily_sales) < 7:
        ...
        # 3. ສະແດງ Metrics (ສ່ວນທີ່ອ້າຍຕ້ອງການ)
        ...
        # 4. ສ້າງ DataFrame ສຳລັບສະແດງກາຟ
        f_df = pd.DataFrame({
        ...
        # 5. ສ້າງກາຟ (ແກ້ໄຂຊື່ Column ໃຫ້ຕົງກັນແລ້ວ)
        fig = px.line(f_df, 
                      x='ວັນທີ', 
                      y='ຍອດຄາດຄະເນ (฿)', 
                      markers=True, 
